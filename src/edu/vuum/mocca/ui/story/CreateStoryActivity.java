...
public class CreateStoryActivity extends StoryActivityBase {
    ...
    /**
     * @brief Gets a file to write media files
     *
     * @param type The type of media to be stored
     *
     * @return The file to write the media or null if not found
     */
	...
	private void launchSoundIntent() {
        ...
        File outputFile = getOutputMediaFile(MEDIA_TYPE_AUDIO);
        if(outputFile == null) {
            return;
        }
        ...
        intent.putExtra(SoundRecordActivity.EXTRA_OUTPUT, outputFile.getAbsolutePath());
	...
	private void launchCameraIntent() {
        ...
        fragment.imagePath = Uri.fromFile(outputFile);
    ...
    private boolean hasCamera(){
        if(!getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_ANY)) {
            Toast.makeText(getApplicationContext(), "No camera exists on the device", Toast.LENGTH_LONG).show();
            return false;
        }
        return true;
    }
    ...
    private boolean hasSD() {
        if(!android.os.Environment.getExternalStorageState().equals(android.os.Environment.MEDIA_MOUNTED)) {
            Toast.makeText(getApplicationContext(), "No SD CARD exists on the device", Toast.LENGTH_LONG).show();
            return false;
        }
        return true;
    }
